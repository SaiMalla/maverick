...
class TicketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticket" do
    assert_difference('Ticket.count') do
      post tickets_url, params: { ticket: { batchnumber: @ticket.batchnumber, caller_type_id: @ticket.caller_type_id, customer_id: @ticket.customer_id, description: @ticket.description, employee_id: @ticket.employee_id, expirydate: @ticket.expirydate, manufacturedate: @ticket.manufacturedate, product_id: @ticket.product_id, product_sku_id: @ticket.product_sku_id, purchasepoint: @ticket.purchasepoint, resolution: @ticket.resolution, source_id: @ticket.source_id, tag_user_id: @ticket.tag_user_id, ticket_attachment_id: @ticket.ticket_attachment_id, ticket_status_id: @ticket.ticket_status_id, ticket_sub_status_id: @ticket.ticket_sub_status_id, ticket_sub_type_id: @ticket.ticket_sub_type_id, ticket_type_id: @ticket.ticket_type_id } }
    end
