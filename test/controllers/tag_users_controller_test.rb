...
class TagUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tag_user" do
    assert_difference('TagUser.count') do
      post tag_users_url, params: { tag_user: { employee_id: @tag_user.employee_id, ticket_id: @tag_user.ticket_id } }
    end
  ...
  test "should update tag_user" do
    patch tag_user_url(@tag_user), params: { tag_user: { employee_id: @tag_user.employee_id, ticket_id: @tag_user.ticket_id } }
