...
class TicketsTest < ApplicationSystemTestCase
  ...
  test "creating a Ticket" do
    ...
    fill_in "Product sku", with: @ticket.product_sku_id
    ...
    fill_in "Tag user", with: @ticket.tag_user_id
    fill_in "Ticket attachment", with: @ticket.ticket_attachment_id
    fill_in "Ticket status", with: @ticket.ticket_status_id
    fill_in "Ticket sub status", with: @ticket.ticket_sub_status_id
    fill_in "Ticket sub type", with: @ticket.ticket_sub_type_id
